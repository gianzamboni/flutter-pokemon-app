...
class FavouritePokemonService {
  ...
  static Future<List<Pokemon>> swapFavouritePokemons(String token, int index1, int index2) async {
  ...
  static Future<void> deleteFavouritePokemon(String token, int index) async {
